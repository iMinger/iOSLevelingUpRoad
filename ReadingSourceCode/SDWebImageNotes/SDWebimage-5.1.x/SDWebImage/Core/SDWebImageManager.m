...
//SDWebImageCombinedOperation 这个oparation 中包含两个操作：loaderOperation和cacheOperation
...
// 注意，这里将operation所在的manager弱引用。防止循环引用
...
- (SDWebImageCombinedOperation *)loadImageWithURL:(nullable NSURL *)url
    ...
    // 新创建一个图片绑定操作,将这个操作的管理者指定为本manager
    ...
    // 将operation 添加到该管理类manager的runningOperations的集合中。
