...
// 注意比较SDImageCache和SDMemroryCache 和SDDiskCache 这三个协议的区别
...
#pragma mark 这里为什么要添加一个分类，然后让这个分类遵循SDImageCache协议
// 这里添加了一个SDImageCache+SDImageCache的分类，这个分类遵循了SDImageCache协议。 分类的实现中实现了协议中响应的代理方法
